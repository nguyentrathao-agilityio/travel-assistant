...
vi.mock('../weather', () => ({ getWeather: (...args: unknown[]) => getWeatherMock(...args) }));
vi.mock('../tips', () => ({ getLocalTips: (...args: unknown[]) => getLocalTipsMock(...args) }));
vi.mock('../places', () => ({ getPlaces: (...args: unknown[]) => getPlacesMock(...args) }));

import { getDestinationExplorer } from '../destination-explorer';
